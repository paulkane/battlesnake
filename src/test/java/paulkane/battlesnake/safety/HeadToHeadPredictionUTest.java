...
public class HeadToHeadPredictionUTest {
    ...
    public void safeToMoveUp() {
        boolean isSafe = headToHeadPrediction.isItSafe(MOVE.UP, battleSnakeRequest(snake(body(5, 5)),
            snake(body(5, 6)),
            snake(body(4, 5)),
            snake(body(6, 5))
        ));
    ...
    public void safeToMoveDown() {
        boolean isSafe = headToHeadPrediction.isItSafe(MOVE.DOWN, battleSnakeRequest(snake(body(5, 5)),
            snake(body(5, 4)),
            snake(body(4, 5)),
            snake(body(6, 5))
        ));
    ...
    public void safeToMoveLeft() {
        boolean isSafe = headToHeadPrediction.isItSafe(MOVE.LEFT, battleSnakeRequest(snake(body(5, 5)),
            snake(body(5, 6)),
            snake(body(5, 4)),
            snake(body(6, 5))
        ));
    ...
    public void safeToMoveRight() {
        boolean isSafe = headToHeadPrediction.isItSafe(MOVE.RIGHT, battleSnakeRequest(snake(body(5, 5)),
            snake(body(5, 6)),
            snake(body(5, 4)),
            snake(body(4, 5))
        ));
    ...
    public void safeToMoveUpAsImBigger() {
        boolean isSafe = headToHeadPrediction.isItSafe(MOVE.UP, battleSnakeRequest(snake(body(5, 5), body(5, 4)),
            snake(body(5, 3))
        ));
    ...
    public void safeToMoveDownAsImBigger() {
        boolean isSafe = headToHeadPrediction.isItSafe(MOVE.DOWN, battleSnakeRequest(snake(body(5, 5), body(5, 4)),
            snake(body(5, 7))
        ));
    ...
    public void safeToMoveLeftAsImBigger() {
        boolean isSafe = headToHeadPrediction.isItSafe(MOVE.LEFT, battleSnakeRequest(snake(body(5, 5), body(5, 4)),
            snake(body(3, 5))
        ));
    ...
    public void safeToMoveRightAsImBigger() {
        boolean isSafe = headToHeadPrediction.isItSafe(MOVE.RIGHT, battleSnakeRequest(snake(body(5, 5), body(5, 4)),
            snake(body(7, 5))
        ));
    ...
    public void safeToMove() throws Exception {
        ...
        boolean isSafe = headToHeadPrediction.isItSafe(MOVE.UP, SnakeHelper.battleSnakeRequestFromJson(
